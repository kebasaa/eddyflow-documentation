...
!!! note
    ...
    The higher the number of sectors, the longer the planar fit subset must be, so as to assure that enough data are available for each sector to perform a robust bi-linear fit.
