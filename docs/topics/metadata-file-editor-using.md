...
7. **Manufacturer:** The make of the anemometer.
                                                                    ...
                                                                    **Acquisition frequency** and **Sampling:** Leave both at their station defaults unless this anemometer samples slower than the station or reports averaged rather than instantaneous values. See [Metadata File Editor](metadata-file-editor.md#Instrume) for details.
8. For Gas Analyzers Info: EddyFlow supports multiple gas analyzers and hygrometers at the same station (up to 64 gas channels in total), so add one entry per instrument if your station has more than one, whether they measure the same or different species.
9. **Manufacturer:** The make of your gas analyzer.
                                                                    ...
                                                                    **Acquisition frequency** and **Sampling:** Leave both at their station defaults unless this analyzer samples slower than the station or reports averaged rather than instantaneous values. See [Metadata File Editor](metadata-file-editor.md#Instrume) for details.
